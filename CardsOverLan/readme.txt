...
1. Open settings.json and set the "host_url" property to the URL and port you want to host the webapp on. Customize your other game settings as desired.
...
If you'd rather add firewall exceptions manually, make sure to whitelist your selected host and WebSocket ports.
