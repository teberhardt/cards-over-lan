(function (g) {
    ...
    g.setLpIgnore = function() {
        const inputElements = elems("input");
        for (let e of inputElements) {
            e.setAttribute("data-lpignore", "true");
        }
    }

    g.showModal = function (modalName) {
    ...
    g.hideModal = function (modalName) {
        let e = document.getElementById(modalName);
        if (e) {
    ...
    g.setEnabled = function(elementName, enabled) {
        if (enabled) {
            enable(elementName);
        } else {
            disable(elementName);
    ...
    g.disable = function(elementName) {
    ...
    const modalShowButtons = elems("input[type=button][data-modal-show]");
